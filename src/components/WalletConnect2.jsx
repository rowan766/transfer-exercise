    ...
    return (
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="p-3 bg-gray-50 rounded-lg">
            ...
            {loading ? (
              ...
              <div>
                ...
                <button onClick={retryBalance} className="text-blue-600 hover:text-blue-800 text-sm font-medium">
                  重试获取余额
                </button>
              </div>
            ) : balance !== null ? (
          ...
          <button onClick={disconnect} className="w-full bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded transition duration-200">
            断开连接
          </button>
        </div>
      </div>
  ...
  return (
    <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-gray-500 text-center">请确保已安装 MetaMask 浏览器扩展</p>
      </div>
    </div>
  );
}
